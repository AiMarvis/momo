...
export const KO_MESSAGES = {
  ...
  "settings.plugin.ai_chat.agent_provider.open_codex": "Codex 설정 열기",
  ...
  "settings.plugin.ai_chat.openai.key_label": "OpenAI API 키",
  "settings.plugin.ai_chat.openai.configured": "OpenAI 키가 macOS Keychain에 저장되어 있어요.",
  "settings.plugin.ai_chat.openai.not_configured": "이 기기에 저장된 OpenAI 키가 없어요.",
  ...
  "settings.plugin.graph_view.action.replay_animation": "애니메이션 재생",
  "settings.plugin.graph_view.section.filter": "필터",
  "settings.plugin.graph_view.section.groups": "그룹",
  "settings.plugin.graph_view.section.forces": "장력",
  ...
  "settings.plugin.graph_view.field.show_arrows": "화살표",
  "settings.plugin.graph_view.field.label_visibility_threshold": "텍스트 표시 시작점",
  "settings.plugin.graph_view.field.node_size": "노드 크기",
  "settings.plugin.graph_view.field.charge_strength": "반발력",
  ...
  "settings.plugin.graph_view.field.center_strength": "중심 장력",
  "settings.plugin.graph_view.field.link_strength": "링크 장력",
  "settings.plugin.graph_view.field.link_distance": "링크 거리",
  ...
  "chat.panel.setup.title": "Codex 설정",
  ...
  "chat.panel.setup.byok_hint":
    "에이전트가 없어도 수동 노트, 검색, 그래프, 대시보드, 검토 작업은 계속 사용할 수 있어요.",
