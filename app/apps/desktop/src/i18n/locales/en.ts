...
export const EN_MESSAGES = {
  ...
  "settings.plugin.ai_chat.agent_provider.open_codex": "Open Codex setup",
  ...
  "settings.plugin.ai_chat.openai.key_label": "OpenAI API key",
  "settings.plugin.ai_chat.openai.configured": "An OpenAI key is stored in macOS Keychain.",
  "settings.plugin.ai_chat.openai.not_configured": "No OpenAI key is stored on this device.",
  ...
  "settings.plugin.graph_view.action.replay_animation": "Replay animation",
  "settings.plugin.graph_view.section.filter": "Filter",
  "settings.plugin.graph_view.section.groups": "Groups",
  "settings.plugin.graph_view.section.forces": "Forces",
  ...
  "settings.plugin.graph_view.field.show_arrows": "Arrows",
  "settings.plugin.graph_view.field.label_visibility_threshold": "Text display threshold",
  "settings.plugin.graph_view.field.node_size": "Node size",
  "settings.plugin.graph_view.field.charge_strength": "Repel force",
  ...
  "settings.plugin.graph_view.field.center_strength": "Center force",
  "settings.plugin.graph_view.field.link_strength": "Link force",
  "settings.plugin.graph_view.field.link_distance": "Link distance",
  ...
  "chat.panel.setup.title": "Set up Codex",
  ...
  "chat.panel.setup.byok_hint":
    "Manual notes, search, graph, dashboard, and review work remain available without an agent.",
  ...
  "editor.slash.horizontal_rule.title": "Horizontal Rule",
  "editor.slash.horizontal_rule.description": "Insert a divider.",
  ...
  "editor.slash.table.description": "Insert a 3 by 3 table.",
