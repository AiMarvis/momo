...
export const JA_MESSAGES = {
  ...
  "settings.plugin.ai_chat.agent_provider.open_codex": "Codex 設定を開く",
  ...
  "settings.plugin.ai_chat.openai.key_label": "OpenAI API キー",
  "settings.plugin.ai_chat.openai.configured": "OpenAI キーは macOS Keychain に保存されています。",
  "settings.plugin.ai_chat.openai.not_configured": "この端末に保存された OpenAI キーはありません。",
  ...
  "settings.plugin.graph_view.action.replay_animation": "アニメーションを再生",
  "settings.plugin.graph_view.section.filter": "フィルター",
  "settings.plugin.graph_view.section.groups": "グループ",
  "settings.plugin.graph_view.section.forces": "力",
  ...
  "settings.plugin.graph_view.field.show_arrows": "矢印",
  "settings.plugin.graph_view.field.label_visibility_threshold": "テキスト表示開始",
  "settings.plugin.graph_view.field.node_size": "ノードサイズ",
  "settings.plugin.graph_view.field.charge_strength": "反発力",
  ...
  "settings.plugin.graph_view.field.center_strength": "中心の力",
  "settings.plugin.graph_view.field.link_strength": "リンクの力",
  "settings.plugin.graph_view.field.link_distance": "リンク距離",
  ...
  "editor.table.menu": "表",
  "editor.table.add_row_above": "上に行を追加",
  ...
  "editor.table.delete_table": "表を削除",
  ...
  "chat.panel.setup.title": "Codex を設定",
  ...
  "chat.panel.setup.byok_hint":
    "エージェントなしでも手動ノート、検索、グラフ、ダッシュボード、レビュー作業は使えます。",
  ...
  "editor.slash.horizontal_rule.title": "区切り線",
  "editor.slash.horizontal_rule.description": "水平の区切り線を挿入します。",
  "editor.slash.image.title": "画像",
  "editor.slash.image.description": "URL から画像を挿入します。",
  "editor.slash.image.prompt": "画像 URL",
  "editor.slash.table.title": "表",
  "editor.slash.table.description": "3 x 3 の表を挿入します。",
